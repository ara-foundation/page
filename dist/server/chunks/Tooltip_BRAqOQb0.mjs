...
const Component = ({ children, content, openDelay = 50, tooltipClassName }) => {
  ...
  return /* @__PURE__ */ jsx(TooltipProvider, { openDelay, children: /* @__PURE__ */ jsxs(Tooltip, { children: [
    /* @__PURE__ */ jsx(TooltipTrigger, { asChild: true, className: "", children }),
    /* @__PURE__ */ jsx(
      TooltipContent,
      {
        autoFocus: true,
...
export { Component as C, Slot as S, TooltipProvider as T, Tooltip as a, TooltipTrigger as b, TooltipContent as c, getStrictContext as g };
