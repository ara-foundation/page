...
import { s as socialLinks, $ as $$ClientRouter, e as $$Analytics, d as SocialLink } from './Analytics_BsLGyV9d.mjs';
/* empty css                         */
/* empty css                         */
...
Discuss
</a> <a href="/roadmap" class="hover:text-neutral-900 dark:hover:text-neutral-200">
Roadmap
</a> <a${addAttribute(whitepaperUrl, "href")} class="hover:text-neutral-900 dark:hover:text-neutral-200">
Whitepaper
...
}, "/home/medet/ara/page/src/layouts/MinimalDarkLayout.astro", void 0);
